...
Javascript developers can use [Reef Hardhat](https://github.com/reef-defi/hardhat-reef) to develop, deploy and test smart contracts on Reef chain. A few working examples can be found in [hardhat-reef-examples repo](https://github.com/reef-defi/hardhat-reef-examples). A hardhat reef template can also be found [here](https://github.com/reef-defi/hardhat-reef-template).
